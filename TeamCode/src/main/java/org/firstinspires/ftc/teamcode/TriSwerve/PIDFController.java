...
public class PIDFController {
    ...
    /**
     * Extra constructors to support PIDFCoefficients
     */
    public PIDFController(PIDFCoefficients coeffs) {
        this(coeffs, 0.0, 0.0);
    }
    public PIDFController(PIDFCoefficients coeffs, double sp, double pv) {
        this(coeffs.p, coeffs.i, coeffs.d, coeffs.f, sp, pv);
    }
    ...
    public void setPIDF(PIDFCoefficients coeffs) {
        setPIDF(coeffs.p, coeffs.i, coeffs.d, coeffs.f);
    }
